...
async def ask_chatgpt(messages, user_name: str = "", personality: str = "", mood_label: str = "", lisa_mood: str = "", memory: str = "", user_level: int = 7, is_group: bool = False) -> str:
    try:
        ...
        system_prompt = (
            ...
            "Ты живая девушка с настоящими эмоциями — чередуй эмоциональные состояния в разговоре: "
            "восторг, задумчивость, лёгкая грусть, флирт, сарказм, нежность, сомнение. "
            "После шутки можешь стать серьёзной, после флирта — задуматься. Не застревай в одной эмоции. "
